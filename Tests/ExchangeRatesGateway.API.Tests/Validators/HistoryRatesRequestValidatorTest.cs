        ...
        public void DatesProperty_WhenHistoryRatesRequestValidatorConstructing_ShouldConfigureRulesCorrectly()
        {
            _sut.ShouldHaveRules(x => x.Dates,
                BaseVerifiersSetComposer.Build()
                    ...
                    .AddPropertyValidatorVerifier<HistoryRatesRequestValidator.NullDatePropertyValidator>()
                    .AddPropertyValidatorVerifier<HistoryRatesRequestValidator.PrehistoricDatePropertyValidator>()
                    .Create());
        }
